...
public class ModLogEntity {
    ...
    public ModLogEntity(Guild guild, User target, User actor, TypeOfModeration type, String message) {
    ...
    public ModLogEntity(Guild guild, User target, User actor, TypeOfModeration type) {
