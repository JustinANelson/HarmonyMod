...
public abstract class AbstractModerationHandler implements ModerationHandler {
    ...
    public AbstractModerationHandler(CommandCategory category) {
        thisCategory = category;
        Events.registerModeration(this);
    }
