...
public abstract class AbstractMessageReceivedCommander implements MessageReceivedCommander {
    ...
    public AbstractMessageReceivedCommander(CommandCategory category) {
        thisCategory = category;
        Commands.registerMessageReceivedCommand(this);
    }
